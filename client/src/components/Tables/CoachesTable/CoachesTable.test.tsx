...
import { useCoaches, type TCoachesSchema } from '@hooks/useCoaches';
import type { TTrainingStatus } from '@lib/types';

const mockCoaches: TCoachesSchema = [
  { coach_id: 1, first_name: 'John', last_name: 'Doe', email: 'john@test.com', user_status: 'active', status: 'trained', disabled: 0, coordinator_id: 1, coordinator_first_name: 'Jane', coordinator_last_name: 'Smith', area_id: 1, area_name: 'North Area', email_consent: 1, whatsapp_consent: 1, dbs_completed: 1, ref_completed: 1, commitment_completed: 1, training: 'completed' as TTrainingStatus, edib_training: 'completed' as TTrainingStatus, consol_training: 'completed' as TTrainingStatus, use_email: 1, consol_training_at: '2024-01-15', availability: 'weekends', preferences: 'none', notes: 'good coach', created_at: '2024-01-01', password_reset: 0 },
  { coach_id: 2, first_name: 'Jane', last_name: 'Smith', email: 'jane@test.com', user_status: 'leaver', status: 'untrained', disabled: 0, coordinator_id: 1, coordinator_first_name: 'Jane', coordinator_last_name: 'Smith', area_id: 1, area_name: 'North Area', email_consent: 1, whatsapp_consent: 0, dbs_completed: 0, ref_completed: 0, commitment_completed: 0, training: 'not_booked' as TTrainingStatus, edib_training: 'not_booked' as TTrainingStatus, consol_training: 'not_booked' as TTrainingStatus, use_email: 0, consol_training_at: null, availability: null, preferences: null, notes: null, created_at: '2024-01-02', password_reset: 0 },
  { coach_id: 3, first_name: 'Bob', last_name: 'Wilson', email: 'bob@test.com', user_status: 'active', status: 'paired', disabled: 1, coordinator_id: 2, coordinator_first_name: 'Bob', coordinator_last_name: 'Manager', area_id: 2, area_name: 'South Area', email_consent: 0, whatsapp_consent: 1, dbs_completed: 1, ref_completed: 1, commitment_completed: 1, training: 'booked' as TTrainingStatus, edib_training: 'completed' as TTrainingStatus, consol_training: 'not_booked' as TTrainingStatus, use_email: 1, consol_training_at: null, availability: 'evenings', preferences: 'online', notes: 'experienced', created_at: '2024-01-03', password_reset: 1 },
];
