...
export const ContactBlock = () => (
  <>
    ...
    <p>For support or questions, please reach out to us:</p>
    <p>Email: <a href="mailto:hcdataprotection@readeasy.org.uk">hcdataprotection@readeasy.org.uk</a></p>
  </>
);
// -----------------------------------------------------------------------------
...
export const IntroBlock = () => (
  <>
  <h1 className="text-2xl pt-5 mb-5">Welcome to the Read Easy Connect test site</h1>
      
  <p>
    This site provides an opportunity to test the functionality of the Connect
    app which is currently in development. The purpose of this test site is to
    allow prospective users to familiarise themselves with the appearance, 
    design and functionality of the app - and to provide feedback regarding 
    its use and any bugs that may be discovered.
  </p>
  <p>
    Please note that the test app must not be used to process real personal 
    data relating to Coaches, Readers, etc.
  </p>

  <p>
    In order to use the app, choose the <strong>Login</strong> menu option 
