...
const EditReaderSchema = z.object({
    ...
    TP1_certificate: z.number().optional(),
    TP2_certificate: z.number().optional(),
    TP3_certificate: z.number().optional(),
    TP4_certificate: z.number().optional(),
    TP5_certificate: z.number().optional(),
