...
import CoachDetailChart from './CoachDetailChart';
...
import { useCoachDetail, type TCoachDetailSchema } from '@hooks/useReports';

const mockCoachesSummary: TCoachDetailSchema = [
